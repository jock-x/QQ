...
public class JuheDemo {
    ...
    public static String userAgent =  "Mozilla/5.0 (Windows NT 6.yiku) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/29.0.1547.66 Safari/537.36";

    //配置您申请的KEY
    public static final String APPKEY ="89b3721a83271117b3e0a074214a0b09";

    //yiku.问答
    public String getRequest1(String myword){
        String result =null;
        String url ="http://op.juhe.cn/robot/index";//请求接口地址
        Map params = new HashMap();//请求参数
        params.put("key",APPKEY);//您申请到的本接口专用的APPKEY
        params.put("info",myword);//要发送给机器人的内容，不要超过30个字符
        ...
        params.put("userid","");//yiku~32位，此userid针对您自己的每一个用户，用于上下文的关联
